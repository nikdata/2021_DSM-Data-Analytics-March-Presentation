...
### `r fa(name = 'map', fill = 'steelblue')` R Interface to Python
...
### `r fa(name = 'globe', fill = 'steelblue')` Work within any virtual environment  
...
- #### deep learning!
- #### some libraries are easier to use (e.g., SMOTE, JSON)
...
Reticulate may not work with all python packages.
...
#### `r fa(name = 'r-project', fill = 'steelblue')` Use R functions as much as possible
